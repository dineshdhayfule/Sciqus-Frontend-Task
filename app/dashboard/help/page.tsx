    ...
    <div className="grid gap-6 p-4 md:p-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {resources.map((resource) => (
          <Card
            key={resource.title}
            className="bg-card border-card-border hover:shadow-lg transition-shadow cursor-pointer"
          >
            <CardHeader>
            ...
            <CardContent>
              <Button
                variant="outline"
                size="sm"
                className="border-input text-foreground hover:bg-background bg-transparent"
              >
                Learn More
              </Button>
            </CardContent>
      ...
      <Card className="bg-card border-card-border">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" className="border-input text-foreground hover:bg-background bg-transparent">
              Schedule a Demo
            </Button>
          </div>
        </CardContent>
